...
function DoctorPatientView() {
  ...
  console.log("kjsadjsahd ", location.state.patientData.age)
...
// Calculate the age based on the difference in milliseconds
const ageInMilliseconds = new Date(timeDiff);

// Get the year from the age in milliseconds
          ...
          <div className="home-page-body-main-container">
            <div className="home-page-body-main-container-left">
              <div className="patient-profile-card">
                ...
                {patientData && patientData.avatar && (
  <div className="patient-profile-card-photo">
...
<div className="DoctorPatientView-FooterButton">
<button
                ...
                <button
                  className="doctorPatientView-CheckOut-btn" 
